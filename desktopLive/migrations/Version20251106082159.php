 ...
 */
final class Version20251106082159 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE commande (id_commande SERIAL NOT NULL, id_state INT NOT NULL, id_client INT NOT NULL, id_seller INT NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id_commande))');
        ...
        $this->addSql('CREATE TABLE item (id_item SERIAL NOT NULL, id_seller INT NOT NULL, id_category INT NOT NULL, name_item VARCHAR(255) NOT NULL, images VARCHAR(255) DEFAULT NULL, Description TEXT DEFAULT NULL, PRIMARY KEY(id_item))');
